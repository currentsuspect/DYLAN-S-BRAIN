...
var EditInNeovim = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    this.spawnNewInstance = (nvim, adapter) => {
      child_process.spawn(
  ...
  async onload() {
    ...
    console.log(
      "Edit in Neovim Loaded! will look for neovim listening at: " + this.settings.listenOn
    );
    this.registerEvent(
...
var EditInNeovimSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Terminal").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Neovim server location").setDesc(
    ...
    new import_obsidian.Setting(containerEl).setName("Open on startup").setDesc("Open the Neovim instance when Obsidian opens").addToggle(
    ...
    new import_obsidian.Setting(containerEl).setName("Supported file types").setDesc(
